...
| [`markdowns/design/brand-guide-template.md`](markdowns/design/brand-guide-template.md) + [`personas/_template.md`](markdowns/design/personas/_template.md) + [`copywriting/register-template.md`](markdowns/copywriting/register-template.md) + [`engineering/interaction-performance-template.md`](markdowns/engineering/interaction-performance-template.md) | Surface skeletons — copy to project files when authoring brand, persona, copywriting register, and interaction-performance artifacts. The interaction-performance skeleton is the template behind the measurable bar FCPSS's "P" delegates to (the filled copy is the bar; the skeleton is never in force). |
